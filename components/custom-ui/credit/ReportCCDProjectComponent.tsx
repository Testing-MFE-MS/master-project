        ...
        const attemptLoad = async (): Promise<void> => {
            try {
                ...
                if (typeof window !== 'undefined') {
                    const loadedModule = await import('ccdPage/ReportLoanUser').catch((err) => {
                        console.error('Failed to load ReportLoanUser:', err);
                        throw new Error(`Remote module not available: ${err.message}`);
                    });

                    setCCDComponent(() => loadedModule.default || loadedModule);
                }
            } catch (err) {
            ...
            <div className="space-y-4 -mt-14">
                <div className="flex items-center justify-center min-h-[400px]">
                    <div className="text-center">
                        ...
                        <p className="text-muted-foreground font-medium">Loading Report Module...</p>
                        <p className="text-xs text-muted-foreground mt-2">
                            Connecting to CCD service on port 3001...
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="bg-destructive/10 text-destructive rounded-lg p-6">
                            ...
                            <div className="text-xs text-left bg-background/50 p-4 rounded-md mb-4">
                                ...
                                <ul className="space-y-1 list-disc list-inside text-muted-foreground">
                                    ...
                                    <li>Check CCD project&apos;s next.config.ts exposes</li>
